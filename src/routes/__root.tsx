...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Alex Rivera" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Rashi Sawardekar — B.Sc. IT Student · Developer · AI & FinTech" },
      { name: "twitter:title", content: "Rashi Sawardekar — B.Sc. IT Student · Developer · AI & FinTech" },
      ...
      { name: "twitter:description", content: "Portfolio of Rashi Sawardekar — B.Sc. Information Technology student (CGPA 9.13, Minor in Finance) building AI, full-stack, and FinTech projects with Python, Java, and modern web tech." },
    ],
    links: [
